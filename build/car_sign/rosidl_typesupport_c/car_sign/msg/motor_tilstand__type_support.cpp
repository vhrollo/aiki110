...
static const _MotorTilstand_type_support_symbol_names_t _MotorTilstand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, car_sign, msg, MotorTilstand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, car_sign, msg, MotorTilstand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, car_sign, msg, MotorTilstand)() {
  return &::car_sign::msg::rosidl_typesupport_c::MotorTilstand_message_type_support_handle;
}
