...
#ifndef CAR_SIGN__SRV__DETAIL__CAR_BRYTERTILSTAND__FUNCTIONS_H_
#define CAR_SIGN__SRV__DETAIL__CAR_BRYTERTILSTAND__FUNCTIONS_H_
...
#include "car_sign/msg/rosidl_generator_c__visibility_control.h"

#include "car_sign/srv/detail/car_brytertilstand__struct.h"

/// Initialize srv/CarBrytertilstand message.
/**
...
/// Create srv/CarBrytertilstand message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * car_sign__srv__CarBrytertilstand_Request__init().
...
/// Destroy srv/CarBrytertilstand message.
/**
 * It calls
 * car_sign__srv__CarBrytertilstand_Request__fini()
...
/// Check for srv/CarBrytertilstand message equality.
/**
...
/// Copy a srv/CarBrytertilstand message.
/**
...
/// Initialize array of srv/CarBrytertilstand messages.
/**
...
/// Finalize array of srv/CarBrytertilstand messages.
/**
 * It calls
 * car_sign__srv__CarBrytertilstand_Request__fini()
...
/// Create array of srv/CarBrytertilstand messages.
/**
 * It allocates the memory for the array and calls
 * car_sign__srv__CarBrytertilstand_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/CarBrytertilstand messages.
/**
 * It calls
 * car_sign__srv__CarBrytertilstand_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/CarBrytertilstand message array equality.
/**
...
/// Copy an array of srv/CarBrytertilstand messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * car_sign__srv__CarBrytertilstand_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_car_sign
...
/**
 * It calls
 * car_sign__srv__CarBrytertilstand_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_car_sign
...
/**
 * It allocates the memory for the array and calls
 * car_sign__srv__CarBrytertilstand_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_car_sign
...
/**
 * It calls
 * car_sign__srv__CarBrytertilstand_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CAR_SIGN__SRV__DETAIL__CAR_BRYTERTILSTAND__FUNCTIONS_H_
