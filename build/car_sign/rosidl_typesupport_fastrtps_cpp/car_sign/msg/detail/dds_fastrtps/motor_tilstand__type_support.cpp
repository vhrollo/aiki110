...
#include "car_sign/msg/detail/motor_tilstand__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const car_sign::msg::MotorTilstand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<car_sign::msg::MotorTilstand *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MotorTilstand__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const car_sign::msg::MotorTilstand *>(
...
static size_t _MotorTilstand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MotorTilstand(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MotorTilstand__callbacks = {
  "car_sign::msg",
  "MotorTilstand",
...
static rosidl_message_type_support_t _MotorTilstand__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MotorTilstand__callbacks,
...
{
  return &car_sign::msg::typesupport_fastrtps_cpp::_MotorTilstand__handle;
}
